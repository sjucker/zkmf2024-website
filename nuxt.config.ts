  ...
  nitro: {
    prerender: {
      routes: [
        ...
        '/verein/sjmuz-schlagzeugensemble',
        ...
        '/verein/sjmuz-percussion-ensemble',
        '/verein/musikverein-grueningen',
        '/verein/brass-band-musig-hittnau',
        '/verein/musikverein-baeretswil',
        '/verein/brass-band-maur',
        '/info/unterhaltung/freitag-abend',
        '/info/unterhaltung/samstag-tag',
        '/info/unterhaltung/samstag-abend',
        '/info/unterhaltung/sonntag',
        '/info/unterhaltung/band/rosalia-golden-hits',
        '/info/unterhaltung/band/stubete-gaeng',
        '/info/unterhaltung/band/dj-outside',
        '/info/unterhaltung/band/jugend-und-blasmusik',
        '/info/unterhaltung/band/braesskalation',
        '/info/unterhaltung/band/saint-city-orchestra',
        '/info/unterhaltung/band/compass',
        '/info/unterhaltung/band/gottesdienst',
        '/info/unterhaltung/band/schaebyschigg',
      ],
    },
  },
})
