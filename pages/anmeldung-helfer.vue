  ...
  <div class='prose max-w-none'>
    ...
    <div v-if='!sent' ref="form">
      ...
      <form class='mt-10'>
          ...
          <div class='flex flex-col'>
            <label class='inline-flex items-center'>
              <input
                  type='radio'
                  value='privat'
                  v-model='vereinszugehoerigkeitSelection'
                  v-on:change='resetVereinszugehoerigkeit()'
              />
            ...
            <label class='inline-flex items-center gap-2'>
              ...
              <input v-if='otherVereinszugehoerigkeitSelected'
                     type='text'
        ...
        <div class='mb-8'>
          <label for='anzahlEinsaetze' class='block text-gray-700 font-bold'>Anzahl möglicher Einsätze à ca. 5
            Stunden</label>
          <input
              type='text'
              id='anzahlEinsaetze'
            ...
            <div v-for='einsatzzeit in einsatzzeiten' class='flex-1 text-center'>
              <label class='p-4'>
                <input
                    type='checkbox'
                    :value='einsatzzeit'
                    v-model='formData.einsatzMittwoch'
                />
              </label>
            </div>
          </div>
            ...
            <div v-for='einsatzzeit in einsatzzeiten' class='flex-1 text-center'>
              <label class='p-4'>
                <input
                    type='checkbox'
                    :value='einsatzzeit'
                    v-model='formData.einsatzDonnerstag'
                />
              </label>
            </div>
          </div>
          <div class='max-w-4xl flex flex-row justify-between mb-4'>
            <div class='flex-1 text-xs'>Freitag, 21.06.2024 (Aufbau Morgen + Nachmittag, Festbetrieb Abend + Nacht)
            </div>
            <div v-for='einsatzzeit in einsatzzeiten' class='flex-1 text-center'>
              <label class='p-4'>
                <input
                    type='checkbox'
                    :value='einsatzzeit'
                    v-model='formData.einsatzFreitag'
                />
              </label>
            </div>
          </div>
            ...
            <div v-for='einsatzzeit in einsatzzeiten' class='flex-1 text-center'>
              <label class='p-4'>
                <input
                    type='checkbox'
                    :value='einsatzzeit'
                    v-model='formData.einsatzSamstag'
                />
              </label>
            </div>
          </div>
            ...
            <div v-for='einsatzzeit in einsatzzeiten' class='flex-1 text-center'>
              <label class='p-4'>
                <input
                    type='checkbox'
                    :value='einsatzzeit'
                    v-model='formData.einsatzSonntag'
                />
              </label>
            </div>
          </div>
            ...
            <div v-for='einsatzzeit in einsatzzeiten' class='flex-1 text-center'>
              <label class='p-4'>
                <input
                    type='checkbox'
                    :value='einsatzzeit'
                    v-model='formData.einsatzMontag'
                />
              </label>
            </div>
          </div>
            ...
            <div v-for='einsatzzeit in einsatzzeiten' class='flex-1 text-center'>
              <label class='p-4'>
                <input
                    type='checkbox'
                    :value='einsatzzeit'
                    v-model='formData.einsatzDienstag'
                />
              </label>
            </div>
          </div>
        ...
        <div class='mb-8'>
          <div>
            <span class='font-bold'
                  :class="validGroesseShirt ? '' : 'invalid text-red-700'">Grösse Helfer-T-Shirt</span><br/>
          </div>
          <div class='flex flex-col'>
            <label class='inline-flex items-center'>
              <input
